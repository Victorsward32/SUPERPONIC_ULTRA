...
public class EggPlantFragment extends Fragment {
   ...
   Button button1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_egg_plant, container, false);
        button1=rootView.findViewById(R.id.eggplant_button);
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                getParentFragmentManager().beginTransaction()
                        .replace(R.id.fragment_container_eggplant, nutriGrowFragment)
                        .addToBackStack(null)
                        .commit();
